...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition RailRifle => new WeaponDefinition
        {
            ...
            {
                PartName = "RailRifle", // name of weapon in terminal
                DeviateShotAngle = 0f,
                ...
                {
                    RateOfFire = 100, // visual only, 0 disables and uses RateOfFire
                    BarrelsPerShot = 1,
                    TrajectilesPerBarrel = 1, // Number of Trajectiles per barrel per fire event.
                    SkipBarrels = 0,
                    ReloadTime = 240, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                    DelayUntilFire = 0, //120 // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                ...
                {
                    PreFiringSound = "", //RailRifle_Charge
                    FiringSound = "", // RailRifle_Fire
                    FiringSoundPerShot = true,
                    ReloadSound = "",
                    NoAmmoSound = "",
                    HardPointRotationSound = "WepTurretGatlingRotate",
                    BarrelRotationSound = "WepShipGatlingRotation",
                    FireSoundEndDelay = 252, // Measured in game ticks(6 = 100ms, 60 = 1 seconds, etc..).
                },
