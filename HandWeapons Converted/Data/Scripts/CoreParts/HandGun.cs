...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition HandGun => new WeaponDefinition
        {
            ...
            HardPoint = new HardPointDef
            {
                ...
                {
                    RateOfFire = 450, // visual only, 0 disables and uses RateOfFire
                    BarrelsPerShot = 1,
                    TrajectilesPerBarrel = 1, // Number of Trajectiles per barrel per fire event.
                    SkipBarrels = 0,
                    ReloadTime = 60, //10800 // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                ...
                {
                    PreFiringSound = "", //HandGun_Charge
                    FiringSound = "", // HandGun_Fire
