...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef RailRifle_Ammo => new AmmoDef
        {
            AmmoMagazine = "RailshotMag",
            AmmoRound = "RailRifle_Ammo",
            ...
            AreaEffect = new AreaDamageDef
            {
                ...
                Base = new AreaInfluence
                {
                    ...
                    EffectStrength = 300f, // For ewar it applies this amount per pulse/hit, non-ewar applies this as damage per tick per entity in area of influence. For radiant 0 == use spillover from BaseDamage, otherwise use this value.
                },
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Particles = new AmmoParticleDef
                {
                    ...
                    Hit = new ParticleDef
                    {
                        ...
                        Color = Color(red: 50f, green: 5f, blue: 5f, alpha: 1f),
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 2.5f,
                        Width = 0.025f,
                        Color = Color(red: 5f, green: 20f, blue: 30f, alpha: 1f),
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        TextureMode = Normal,
                        DecayTime = 1,
                        Color = Color(red: 0.6f, green: 0.75f, blue: 3f, alpha: 1f),
                        Back = false,
                        CustomWidth = 0.0125f,
